   ...
   afterEach('Конец теста', function () {
    ...
    it('Верный логин и верный пароль', function () {
     ...
     it('Проверка восстановления пароля', function () {
        ...
        cy.get(recovery_page.email).type('german@dolnikov.ru'); // Ввела почту для восстановления пароля
     ...
     it('Неверный логин и верный пароль', function () {
        cy.get(main_page.email).type('grman@dolnikov.ru'); // Ввели неверный логин
        cy.get(main_page.password).type(data.password); // Ввели верный пароль
        cy.get(main_page.login_button).click(); // Нажала войти
